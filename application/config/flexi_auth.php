...
*/
	...
	*/ 
	...
	/*$config['database']['user_privileges']['custom_columns'] = array(
																	'upriv_short',
																	'upriv_usec_fk'
																);
	*/
	...
	*/
	...
	$config['database']['custom']['user_profile']['custom_columns'] = array(
																			'upro_name','upro_phone','upro_newsletter'
																		);	
	###++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++###	
	// DATABASE SETTINGS
	###++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++###	
	...
	*/
	$config['security']['login_session_expire'] = 1800;
	...
	*/
	$config['security']['static_salt'] = '<M:o<p;lv2#Q!![n|NB_H:WZGsph}`6m6K=NVu|wS{o1gQs0r)A?>z6vgLVcI&a=';
	...
	*/
	$config['email']['email_template_directory'] = 'extras/email/';
